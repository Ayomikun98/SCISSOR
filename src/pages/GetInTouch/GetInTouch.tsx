          ...
          >
            <div>
              ...
              <div className="text-neutral-500 text-xs flex items-center justify-start">
                To keep you in the loop about our products and services, Scissor needs the contact info you provide. No worries—you can opt out of these updates anytime. For details on how to unsubscribe, our privacy practices, and our commitment to protecting your privacy, check out our Privacy Policy.
              </div>
              <div className="mt-6">
