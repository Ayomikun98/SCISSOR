...
import settingsImage from '/src/assets/images/settings.jpg';
      ...
      <div>
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="text-2xl md:text-4xl max-w-[28ch] text-center mx-4 mb-4 md:mb-4 md:text-[40px] font-bold">
            Perfect Your Profile: Tweak Your Settings and Elevate Your Experience!.
          </div>
          <div className="mb-8">
            <div className="w-[90%] text-center font-medium max-w-[70ch] md:mx-auto pr-4 md:pr-0 ml-4 md:ml-auto md:text-center">
              Our engineering team is busy turning this feature into reality. In the meantime, you can...
