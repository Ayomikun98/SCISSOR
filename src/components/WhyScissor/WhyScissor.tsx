        ...
        <div className="flex w-full md:w-[40%]">
          ...
          <div>
            ...
            <div className="max-w-[37ch] ml-0 md:ml-2.5 font-medium" data-testid="why-paragraph">
             Scissors is your one-stop shop for all things link management. We turn your long URLs into bite-sized links, let you craft custom URLs for any occasion—be it personal, business, or events. Plus, our lightning-fast QR code creation and top-notch analytics keep your links sharp and your tracking on point.
            </div>
          </div>
        </div>
